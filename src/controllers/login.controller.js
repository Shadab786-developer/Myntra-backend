...
const generateRegisterTokens = async (userId) => {
  try {
...
const register = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    //generating access and refresh token
    const { accessToken, refreshToken } = await generateRegisterTokens(
      user._id
    );
...
const registerLogin = asyncHandler(async (req, res) => {
  ...
  //generating access and refresh token
  const { accessToken, refreshToken } = await generateRegisterTokens(user._id);
